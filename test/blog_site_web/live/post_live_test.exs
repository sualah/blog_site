defmodule BlogSiteWeb.PostLiveTest do
  use BlogSiteWeb.ConnCase

  import Phoenix.LiveViewTest
  import BlogSite.BlogFixtures

  @create_attrs %{title: "some title", content: "some content", published_at: "2024-10-28T22:20:00", slug: "some slug"}
  @update_attrs %{title: "some updated title", content: "some updated content", published_at: "2024-10-29T22:20:00", slug: "some updated slug"}
